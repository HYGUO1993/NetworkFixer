...
TRANSLATIONS = {
    ...
    "proxy_ghost.title": "幽灵代理专杀",
    "proxy_ghost.scan_title": "🔍 正在扫描代理环境变量...",
    "proxy_ghost.scanning": "🔍 扫描中",
    "proxy_ghost.no_proxy_found": "✅ 未检测到代理环境变量",
    "proxy_ghost.all_healthy": "🟢 检测到 {count} 个代理配置且运行正常",
    "proxy_ghost.dead_found": "🔴 检测到 {count} 个失效的幽灵代理死胡同",
    "proxy_ghost.healthy_details": "🟢 运行正常的代理：",
    "proxy_ghost.dead_details": "🔴 失效的幽灵代理：",
    "proxy_ghost.proxy_item": "  • {scope} 级别：{name} = {value}",
    "proxy_ghost.fixing": "⚠️ 正在清除失效代理...",
    "proxy_ghost.fix_success": "🚀 修复成功！清除了以下失效代理：",
    "proxy_ghost.fix_result_process": "  • 进程级别：清除 {count} 个变量",
    "proxy_ghost.fix_result_user": "  • 用户级别：清除 {count} 个变量",
    "proxy_ghost.fix_result_machine": "  • 系统级别：清除 {count} 个变量",
    "proxy_ghost.fix_machine_denied": "  ⚠️ 系统级别清除需要管理员权限",
    "proxy_ghost.session_restored": "✅ 当前会话已恢复直连",
    "proxy_ghost.no_dead_proxy": "✅ 未检测到失效的代理配置",
    "proxy_ghost.btn_scan": "检测幽灵代理",
    "proxy_ghost.btn_fix": "一键修复",
    "proxy_ghost.step_scan": "扫描代理环境变量",
    "proxy_ghost.step_fix": "清除失效代理",
    "msg.proxy_ghost_scan.title": "扫描完成",
    "msg.proxy_ghost_scan.no_dead": "未检测到失效的代理配置。\n\n所有检测到的代理都在正常运行。",
    "msg.proxy_ghost_scan.has_dead": "检测到 {count} 个失效的幽灵代理！\n\n这些失效的代理可能导致网络请求失败。\n是否立即清除？",
    "msg.proxy_ghost_fix.title": "修复完成",
    "msg.proxy_ghost_fix.content": "成功清除失效的代理环境变量！\n\n建议重启终端和相关应用以使更改生效。",
}
