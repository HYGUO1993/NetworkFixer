...
TRANSLATIONS = {
    ...
    "proxy_ghost.title": "Proxy Ghost Killer",
    "proxy_ghost.scan_title": "🔍 Scanning proxy environment variables...",
    "proxy_ghost.scanning": "🔍 Scanning",
    "proxy_ghost.no_proxy_found": "✅ No proxy environment variables detected",
    "proxy_ghost.all_healthy": "🟢 Detected {count} proxy configuration(s) running normally",
    "proxy_ghost.dead_found": "🔴 Detected {count} dead ghost proxy deadend(s)",
    "proxy_ghost.healthy_details": "🟢 Healthy proxies:",
    "proxy_ghost.dead_details": "🔴 Dead ghost proxies:",
    "proxy_ghost.proxy_item": "  • {scope} level: {name} = {value}",
    "proxy_ghost.fixing": "⚠️ Clearing dead proxies...",
    "proxy_ghost.fix_success": "🚀 Fix successful! Cleared the following dead proxies:",
    "proxy_ghost.fix_result_process": "  • Process level: cleared {count} variable(s)",
    "proxy_ghost.fix_result_user": "  • User level: cleared {count} variable(s)",
    "proxy_ghost.fix_result_machine": "  • Machine level: cleared {count} variable(s)",
    "proxy_ghost.fix_machine_denied": "  ⚠️ Machine level cleanup requires administrator privileges",
    "proxy_ghost.session_restored": "✅ Current session restored to direct connection",
    "proxy_ghost.no_dead_proxy": "✅ No dead proxy configurations detected",
    "proxy_ghost.btn_scan": "Detect Ghost Proxies",
    "proxy_ghost.btn_fix": "One-Click Fix",
    "proxy_ghost.step_scan": "Scan proxy environment variables",
    "proxy_ghost.step_fix": "Clear dead proxies",
    "msg.proxy_ghost_scan.title": "Scan Complete",
    "msg.proxy_ghost_scan.no_dead": "No dead proxy configurations detected.\n\nAll detected proxies are running normally.",
    "msg.proxy_ghost_scan.has_dead": "Detected {count} dead ghost proxy(ies)!\n\nThese dead proxies may cause network request failures.\nClear them now?",
    "msg.proxy_ghost_fix.title": "Fix Complete",
    "msg.proxy_ghost_fix.content": "Successfully cleared dead proxy environment variables!\n\nRecommend restarting terminal and related apps for changes to take effect.",
}
